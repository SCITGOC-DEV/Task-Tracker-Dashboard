...
const PaginationButtons = ({ totalPages, currentPage, handlePageClick }) => {
  ...
  return (
    <div>
      <ReactPaginate
        ...
        nextLabel={
          showNextButton ? (
            <span className="w-10 h-10 dar:text-white dark:text-white text-gray-900 items-center flex justify-center dark:bg-secondary-dark-bg bg-light-gray rounded-md mr-4">
              <BsChevronRight />
            </span>
          ) : null
        }
